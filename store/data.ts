...
export const data = {
  ...
  mood_page: {
    ...
    page: {
      ...
      slides: [
        ...
        { link: '/stages', src: Slide_6, alt: 'дизайн, який викликає емоції', blackout: 0.2, heading: '', title: 'дизайн, який викликає емоції', subtitle: 'замовити проект' },
      ],
      footer: {
        title: 'Завантажити прайс',
        subtitle: 'Заповніть форму, щоб почати завантаження прайсу',
  ...
  about_page: {
    ...
    page: {
      ...
      title: 'про нас',
      subtitle: 'розробляємо дизайн, який викликає емоції',
