...
const data = {
  ...
  stages: [
    ...
    },
    {
      ...
      description: 'Бригада будівельників, яку Ви оберете, здійснює усі будівельні та оздоблювальні роботи, суворо дотримуючись узгодженого проекту. Дизайнер забезпечує повну комплектацію об’єкта.',
      textColor: theme.colors.beige,
